...
public class PiecePathfinding : MonoBehaviour
{
    ...
    /// FIXME: this breaks if the range value is very large
    /// FIXME: commented out the essential code of this function
    /// </summary>
    /// <param name="fromCell"></param>
    ...
    private static List<HexCell> GetVisibleCells(HexCell fromCell, int range)
    {
        ...
        // FIXME Rework the GetVisibleCells function code
